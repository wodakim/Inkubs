...
/**
 * ARCHITECTURE AAA - SYSTEM MAP
 * Cartographie stricte des modules et dépendances de l'application.
 * Garantit que le Feature Loader trouve les bons chemins pour l'usine à potions.
 */
