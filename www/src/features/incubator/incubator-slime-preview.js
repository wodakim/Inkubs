...
export function createIncubatorSlimePreview() {
    ...
    function mountPreviewRuntime({ startMotion = 'extruding', spawnImpulseY = -16.4 } = {}) {
        ...
        // Ne pas spawner si on est suspendu externalement (ex: prairie active).
        // Cela évite que new SlimeEngine() appelle setCanvas() et écrase le
        // contexte global de rendu de la prairie avec celui de l'incubateur.
