...
import { initPhysicsAccessory } from './slime/installPhysicsAccessories.js';

const PHYSICS_ACC = new Set(['silk_ribbon', 'spectral_tail', 'spring_antenna']);
...
export class Slime {
  constructor(options = {}) {
    ...
    if (PHYSICS_ACC.has(this.accessory)) initPhysicsAccessory(this);
