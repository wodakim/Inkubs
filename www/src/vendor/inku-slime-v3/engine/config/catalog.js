...
export const ACCESSORY_POOLS = {
  cute:[
    ...
    // ── Physics accessories (ultra-rare) ──────────────────────────────────
    {id:'silk_ribbon',w:0.18},{id:'spring_antenna',w:0.12},
  ],
  normal:[
    ...
    // ── Physics accessories (ultra-rare) ──────────────────────────────────
    {id:'silk_ribbon',w:0.15},{id:'spring_antenna',w:0.18},
  ],
  scary:[
    ...
    // ── Physics accessories (ultra-rare) ──────────────────────────────────
    {id:'spectral_tail',w:0.18},{id:'spring_antenna',w:0.10},
  ],
  instable:[
